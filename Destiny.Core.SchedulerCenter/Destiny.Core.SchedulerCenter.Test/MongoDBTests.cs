...
using Destiny.Core.SchedulerCenter.Shared.ExpressionUtil;
using Destiny.Core.SchedulerCenter.Shared.Extensions.OrderExtensions;
using Destiny.Core.SchedulerCenter.Shared.Filter;
using Destiny.Core.SchedulerCenter.TestBase;
using System;
using System.IO;
using System.Threading.Tasks;
using Xunit;

namespace Destiny.Core.SchedulerCenter.Test
{
    public class MongoDBTests : IntegratedTest<MongoDBModelule>
    {
        ...
        public async Task GetPageAsync_Test()
        {
            ...
            OrderCondition[] orderConditions = new OrderCondition[] {
                new OrderCondition("Name",Destiny.Core.SchedulerCenter.Shared.Enums.SortDirectionEnum.Descending),
